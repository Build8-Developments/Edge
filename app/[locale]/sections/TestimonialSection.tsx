...
export function TestimonialSection({ locale, dict }: TestimonialSectionProps) {
  ...
  const testimonials = locale === "ar" ? testimonialsAr : testimonialsEn;
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="bg-white rounded-3xl p-8 shadow-lg h-full">
                ...
                <p
                  className={`text-[#122D8B]/70 text-center leading-relaxed mb-6 ${isRTL ? "font-[var(--font-cairo)]" : ""}`}
                  dir={dir}
                >
                ...
                <div className="text-center">
                  ...
                  <p className={`text-[#122D8B]/50 text-sm ${isRTL ? "font-[var(--font-cairo)]" : ""}`}>
                    {testimonial.role}
                  </p>
                </div>
              </div>
