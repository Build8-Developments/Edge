...
export function PartnersSection({ locale }: PartnersSectionProps) {
  ...
  return (
    <section className="py-12 bg-white border-t border-b border-[#E5E7EB]">
      <div
        ref={scrollRef}
        className={`flex gap-4 overflow-hidden items-center ${isRTL ? "flex-row-reverse" : ""}`}
        ...
        {[...partners, ...partners].map((partner, index) => (
          ...
          >
            <span
              ...
              style={{ color: partner.color, fontFamily: "'Manrope', sans-serif" }}
            >
              {partner.name}
            </span>
          </div>
